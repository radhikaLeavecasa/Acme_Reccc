...
struct CommonMessage {
    ...
    static let ACME_VENDOR = "Acme Recce"
    ...
    static let ENTER_OLD_CODE = "Please enter old code"
    ...
    static let ENTER_RETAIL_NAME = "Please enter retail name"
    ...
    static let ENTER_DIVISION = "Please enter division"
    static let CODE_REPLACEMENT_REQUEST_SUCCESS = "Code replacement request sent!"
...
struct WSRequestParams {
    ...
    static let WS_REQS_PARAM_RETAILER_NAME       = "retailer_name"
    static let WS_REQS_PARAM_ID                  = "id"
    ...
    static let WS_REQS_PARAM_CONTACT             = "contact"
    static let WS_REQS_PARAM_OLD_CODE            = "old_code"
    static let WS_REQS_PARAM_ADDRESS             = "address"
    static let WS_REQS_PARAM_ASM_CONTACT         = "asm_contact"
    static let WS_REQS_PARAM_BRAND               = "brand"
    static let WS_REQS_PARAM_OWNER_ALT_NUM       = "owner_alt_num"
    static let WS_REQS_PARAM_OWNER_STATUS        = "shop_owner_status"
